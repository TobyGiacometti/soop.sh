...
- Shell builtins are used exclusively and subshells are avoided[¹][2].
...
Installing soop.sh is as simple as storing the file [soop.sh][3] in a location of choice.
...
Check out [toolbelt.sh][4] to see soop.sh in action.

---

<a name="soopsh-footnotes"></a>
...
[2]: #soopsh-footnotes
[3]: soop.sh
[4]: https://github.com/TobyGiacometti/toolbelt.sh
